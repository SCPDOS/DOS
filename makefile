...
assemble:
	nasm ./Source/scpdos.asm -o ./Binaries/scpdos.sys -f bin -l ./Listings/SCPDOS/scpdos.lst -O0
...
loader:
	nasm ./Source/Boot/loader.asm -o ./Binaries/loader.bin -f bin -l ./Listings/Boot/loader.lst -O0
