...
%include "./src/dos/Kernel/Proc/memFunc.asm"
%include "./src/dos/Kernel/Proc/progMgmt.asm"
%include "./src/dos/Kernel/Proc/exec.asm"
%include "./src/dos/Kernel/Proc/env.asm"
